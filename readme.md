...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) - Hoppscotch is an online API testing tool that functions simiar to [Postman](https://www.postman.com/). The readme of the project is beautifuly highlighted with Table of Contents, Features, usage, collaborators and authors.  With badges , images and clear written text document, it is one of the beautiful readme.
